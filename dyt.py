...
ooooooooo.             o8o                                  
`888   `Y88.           `"'                                  
 888   .d88' oooo d8b oooo  ooo. .oo.    .ooooo.   .ooooo.  
 888ooo88P'  `888""8P `888  `888P"Y88b  d88' `"Y8 d88' `88b 
 888          888      888   888   888  888       888ooo888 
 888          888      888   888   888  888   .o8 888    .o 
o888o        d888b    o888o o888o o888o `Y8bod8P' `Y8bod8P' 
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://github.com/PiyushGarg0/DaddyBomber/blob/main/.version"
    ).text.strip()
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("DaddyBomber is up-to-date")
        mesgdcrt.GeneralMessage("Starting DaddyBomber")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("DaddyBomber was created by Piyush Garg")
    mesgdcrt.SuccessMessage("DaddyBomber was modified by Piyush Garg")
...
description = """prince bomb - Your Friendly Spammer Application

prince bomb can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

prince Bomber is not intented for malicious uses.
"""
